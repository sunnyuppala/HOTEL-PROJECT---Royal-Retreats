<style>
    ...
    .google-login-button {
        ...
        font-size: 11px;
        gap: 5px;
        text-decoration-color: rgb(246, 250, 250);
    }
    .apple-login-link
    {
        margin-left: 1px;
...
<div class="form-container">
    ...
    <p class="sign-up-label">
        Already have an account?<a href="login.html" class="sign-up-link">Login</a>
   ...
   <div class="buttons-container">
        <div class="apple-login-button">
            ...
            <a href="https://support.apple.com/en-in/111001" class="apple-login-link">Sign up with Apple</a>
        </div>
  ...
  c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z">
            ...
            <a href="https://www.gmail.com" class="google-login-link">Sign up with Google</a>
        </div>
    </div>
</div>